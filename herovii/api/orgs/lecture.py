...
from herovii.validator.forms import TeacherGroupForm
...
@api.route('/lecture/<int:uid>/group/<int:g_id>/join', methods=['POST'])
@auth.login_required
...
@api.route('/lecture/<int:uid>/group/<int:gid>/join', methods=['DELETE'])
@auth.login_required
